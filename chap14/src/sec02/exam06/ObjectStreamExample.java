...
public class ObjectStreamExample {
	...
	public static void writeList() throws Exception {
		...
		FileOutputStream fos=new FileOutputStream("C:/aaastudy/hongong_java/Temp/board.db");
	...
	public static List<Board> readList() throws Exception{
		FileInputStream fis=new FileInputStream("C:/aaastudy/hongong_java/Temp/board.db");
